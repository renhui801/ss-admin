...
//基本设置--------------------------------------------------------------------------------------------
$System_Config['key'] = '@ss_key';			// !!! 瞎 jb 修改此key为随机字符串确保网站安全 !!!
$System_Config['debug'] =  'true';  //  正式环境请确保为 false
$System_Config['appName'] = 'winssm';             //站点名称
$System_Config['baseUrl'] = 'http://ss.winhui.top';            // 站点地址
$System_Config['muKey'] = 'NimaQu';   // mu key 用于校验ss-go mu的请求
$System_Config['db_driver'] = 'mysql';		//数据库程序
$System_Config['db_host'] = '@mysql_host'; //数据库地址
$System_Config['db_database'] = '@mysql_db';			//数据库名
$System_Config['db_username'] = '@mysql_user';		//数据库用户名
$System_Config['db_password'] = '@mysql_pass';			//用户名对应的密码
...
$System_Config['smtp_username'] = 'winhuitop@gmail.com';
$System_Config['smtp_port'] = '465';
$System_Config['smtp_name'] = '';
$System_Config['smtp_sender'] = '';
$System_Config['smtp_passsword'] = 'A123321a';
...
//用户注册设置-----------------------------------------------------------------------------------------
$System_Config['register_mode'] = 'close';					//注册模式。close：关闭，open：开放，invite：仅限邀请码
$System_Config['defaultTraffic'] = '0.35';      // 用户初始流量 单位GB
$System_Config['user_expire_in_default']='1000';      //用户账户过期时间，在注册时设置。（天）
$System_Config['user_class_default']='0';      //用户注册等级，在注册时设置。
$System_Config['user_class_expire_default']='24';      //用户等级过期时间，在注册时设置。（小时）
$System_Config['user_conn']='3';      //用户注册客户端数量限制，0为不限制
$System_Config['user_speedlimit']='0';      //用户注册速度默认限制，0为不限制
$System_Config['reg_auto_reset_day']='1';      //注册时的流量重置日
...
$System_Config['min_port']='50000';      //用户端口池最小值
$System_Config['max_port']='50100';      //用户端口池最大值
